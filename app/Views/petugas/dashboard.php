            ...
            <div class="card shadow-sm border-0 p-4 bg-light">
                ...
                <form action="#" method="POST">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" placeholder="Masukkan Kode Booking (Contoh: TKT-2026XYZ)..." required>
                        <button class="btn btn-dark btn-lg px-4" type="submit">Validasi & Check-In</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <table class="table table-striped align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span class="badge bg-success">28 / 32 Kursi</span></td>
                            <td><button class="btn btn-sm btn-outline-primary">Lihat Daftar Nama</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
