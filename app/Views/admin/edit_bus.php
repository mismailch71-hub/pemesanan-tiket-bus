                ...
                <form action="<?= base_url('admin/bus/update/' . $bus['id']) ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="kelas" class="form-select" required>
                            <option value="Executive" <?= $bus['kelas'] == 'Executive' ? 'selected' : '' ?>>Executive </option>
                            <option value="Bisnis" <?= $bus['kelas'] == 'Bisnis' ? 'selected' : '' ?>>Bisnis </option>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-warning px-4 fw-bold text-dark">Perbarui Bus</button>
                    </div>
                </form>
            </div>
        </div>
